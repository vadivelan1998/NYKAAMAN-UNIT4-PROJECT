...
const getDaata = async function(){
  ...
  var data = await fetch("http://localhost:5700/cart",{
    method:"GET",
    headers:{
...
async function makeDelete(el) {
   var proId = el._id;
   console.log(proId);
   await fetch(`http://localhost:5700/cart/${proId}`,{
    method:"POST",
    headers:{
      Authorization:"Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..r-G0oqdXoeAHj573wPzy-qkA2PFZu2PBPMB1GVhlgXY",
        "Content-Type":"application/json"
    }
  })
